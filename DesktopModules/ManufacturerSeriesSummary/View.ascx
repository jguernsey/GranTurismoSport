<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Jjg.GtsStats.ManufacturerSeriesSummary.View" %>
...
<div class="gtsModuleDiv" >
    <asp:Table runat="server" CssClass="gtsOuterTable">
        <asp:TableRow>
            <asp:TableCell CssClass="gtsHeaderCell" ColumnSpan="2">
                <asp:Label runat="server" ID="lblHomeHeader" CssClass="gtsHeaderLabel" Text="FIA Manufacturer Series" ></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
            ...
            <asp:TableCell>
                <asp:UpdatePanel runat="server" ID="upSeasons" UpdateMode="Always">
                    <ContentTemplate>
        ...
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label runat="server" ID="Label1" Text="Manufacturer:" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:UpdatePanel runat="server" ID="upMan" UpdateMode="Always">
                    <ContentTemplate>
                        <asp:DropDownList runat="server" ID="cboManufacturer" OnSelectedIndexChanged="ManufacturerChanged" CssClass="gtsDropDownList" Width="300px" AutoPostBack="true" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label runat="server" ID="Label2" Text="Country:" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:UpdatePanel runat="server" ID="upCo" UpdateMode="Always">
                    <ContentTemplate>
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
                <asp:UpdatePanel runat="server" ID="upSummary" UpdateMode="Always">
                    <ContentTemplate>
                        <asp:GridView ID="dgvSummary" runat="server" AutoGenerateColumns="False" GridLines="None" CssClass="gtsGridView" OnSelectedIndexChanged="SelectedRowChanged" OnRowDataBound="GridDataBound"  PagerStyle-CssClass="gtsPager" AlternatingRowStyle-CssClass="gtsAlternateRow" OnPageIndexChanging="StatIndexChanging" AllowPaging="true" PageSize="100" AllowCustomPaging="true">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Manufacturer Rank" DataField="ManufacturerRank" >
				                    <ItemStyle CssClass="gtsGridCenterTinyiny" />
			                    </asp:BoundField>
                                <asp:BoundField HeaderText="Driver" DataField="Driver" >
				                    <ItemStyle CssClass="gtsGridLeft" />
			                    </asp:BoundField>
                                <asp:ImageField HeaderText="Manufacturer" DataImageUrlField="ManufacturerId" DataImageUrlFormatString="ImageHandlerM.ashx?imgId={0}" ControlStyle-CssClass="gtsCountryImage" >
    ...
    <asp:Panel ID="updatePanel" runat="server" CssClass="gtsModalPopup" Style="display:none">
        <div class="gtsModalHeader">
            <asp:Label runat="server" ID="lblHeader" CssClass="gtsModalHeaderText" Text="Championship Races"></asp:Label>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel runat="server" ID="UpdatePanel3" UpdateMode="Always">
                            <ContentTemplate>
                                <asp:Image ID="imgDriverMan" runat="server" CssClass="gtsCountryImage" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                    <td>
