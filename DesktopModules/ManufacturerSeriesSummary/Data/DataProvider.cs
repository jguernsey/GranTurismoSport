...
namespace Jjg.GtsStats.ManufacturerSeriesSummary.Data
{
	...
	public abstract class DataProvider
	{
		...
		public static DataProvider Instance()
		{
			if (provider == null)
			{
				const string assembly = "Jjg.GtsStats.ManufacturerSeriesSummary.Data.SqlDataprovider,ManufacturerSeriesSummary";
