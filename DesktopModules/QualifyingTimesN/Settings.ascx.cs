...
namespace Jjg.GtsStats.QualifyingTimesN
{
	...
	/// 
	/// Because the control inherits from QualifyingTimesNSettingsBase you have access to any custom properties
	/// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
	/// </summary>
	/// -----------------------------------------------------------------------------
	public partial class Settings : QualifyingTimesNModuleSettingsBase
	{
