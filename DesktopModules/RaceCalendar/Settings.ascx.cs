...
namespace Jjg.GtsStats.RaceCalendar
{
	...
	/// 
	/// Because the control inherits from RaceCalendarSettingsBase you have access to any custom properties
	/// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
	/// </summary>
	/// -----------------------------------------------------------------------------
	public partial class Settings : RaceCalendarModuleSettingsBase
	{
