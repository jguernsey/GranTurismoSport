...
namespace Jjg.GtsStats.ServerMaintenanceAdmin.Data
{
	...
	public abstract class DataProvider
	{
		...
		public static DataProvider Instance()
		{
			if (provider == null)
			{
				const string assembly = "Jjg.GtsStats.ServerMaintenanceAdmin.Data.SqlDataprovider,ServerMaintenanceAdmin";
